...
<script id="dsq-count-scr" src="//blog-d2mj7kcsq8.disqus.com/count.js" async></script>
<style>
* {
	margin: 0;
	padding: 0;
...
<body>
	<div id="menu">
		<div class="item daegu1">
			<img src="resources/images/bubble.png" title="" class="circle" /> <a
				href="#" class="icon"></a>
			<h2>register</h2>
			<ul>
		...
		<div class="item daegu4">
			...
			<ul>
				...
				<li><a href="haksaList.do">haksaList</a></li>
			</ul>
		</div>
