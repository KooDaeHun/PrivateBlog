...
<body>
	...
	<form action="studentInsert.do" method="post">
		<fieldset>
			<legend>학생등록</legend>
			<ul>
				<li><input type="hidden" value="0" name="bunho"></li>
				<li><label for="나이">나이</label> <input type="number" name="age"
					placeholder="나이입력" required="required"></li>
				...
				<li><label for="학번">학번</label> <input type="text" name="hakbun"
					placeholder="학번입력" required="required"></li>
				<li><input type="submit" value="학생등록"></li>
			</ul>
		</fieldset>
	</form>
	<ul id="portfolio">
		<li><img src="resources/images/daegu1.jpg" title="대구대학교"
			class="daegu" /></li>
		<li><img src="resources/images/daegu2.jpg" title="대구대학교"
			class="daegu" /></li>
		<li><img src="resources/images/daegu3.jpg" title="대구대학교"
			class="daegu" /></li>
	</ul>
